...
function NewProduct({ response }) {
  ...
  let headboardindex=0;
  const headboardIcon = [
    "/assets/images/newicons/headboard-02.png",
    "/assets/images/newicons/headboard-03.png",
    "/assets/images/newicons/headboard-04.png",
  ]
  const headboardtittle = ["Dimond Cube ", "Matching Cube", "Floor Standing", "Standing Cube"];
  ...
  let mattressessindex = 0;

  const mattressesstitle = ["Orthopedic Mattress", "Pocket (Tensel top)", "Pocket Pillow Top", ""];
                                        ...
                                        return (
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              setStorageColorName(storagetitle[storageindex]);
                                              setStorage(
                                        ...
                                        return (
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              console.log(feets);
                                              setImage(feet.image);
                                              setFeetColorName(feettitle[feetindex])
                                            }}
                                          >
                                            <Image
                                              id="img_67"
                                        ...
                                        return (
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              setHeadboardColorName(headboardtittle[headboardindex])
                                            }}
                                          >
                                            <Image
                                              id="img_82"
                                        ...
                                        return (
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              setMattressColorName(mattressesstitle[mattressessindex])
                                            }}
                                          >
                                            <Image
                                              id="img_67"
                        ...
                        <div className="scndbtn">
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              ...
                              <Checkout addToCartHandler={addToCartHandler} price={total} title={bed?.product_name} size={bed?.size} base_price={bed?.price} bedColor={colorName} StorageColorName={storageColorName} feetColorName={feetColorName}  headboardColorName={headboardColorName} mattressColorName={mattressColorName} />
                            </div>
                          </div>
                        </div>
                      </div>
