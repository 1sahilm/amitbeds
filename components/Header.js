            ...
            <div className="row  ">
                  ...
                  <div className="header_search-form">
                    <form className="action-form" action="#">
                      ...
                      <button className="submit" type="submit">
                        <img src="/assets/images/image/Icon material-search.png" style={{height:"22px",opacity:"0.9"}}  alt="bedsdivans" />
                      </button>
                    </form>
                  </div>
              ...
              <div className="col-md-2">
                ...
                <div className="header-actions">
                  ...
                  >
                    {/* <ShoppingCartIcon /> */}
                    <Image width={25} height={25} src="/assets/images/icons/basket.webp" alt="" />
              ...
              <div className="col-md-2">
                ...
                <Image width={40} height={40} src="/assets/images/icons/heart.png" alt="" />
                </div>
              </div>
              ...
              <div className="col-md-12 align-self-center">
                <div className="main-menu manu-color-white">
                  <ul>
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            ...
                            <li>
                              <Link href="/allbed/floridabed">Florida Bed Range</Link>
                            </li>
                            <li>
                              <Link href="/allbed/ambassadorbed">Ambassador Range</Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link href="/allbed/swanbed">
                                Swan Bed Range
                              </Link>
                            </li>
                            <li>
                              <Link href="/allbed/wingbed">
                                Wing Bed Range
                              </Link>
                            </li>
                            <li>
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            ...
                            <li>
                              <Link href="/headboard/PanerlHeadboard">Panerl Headboard</Link>
                            </li>
                            <li>
                              <Link href="/headboard/cubeheadboard">Cube Headboard</Link>
                            </li>
                            <li>
                              <Link href="/headboard/plainheadboard">Plain Headboard</Link>
                            </li>
                            <li>
                              <a href="#" style={{ color: "#262884" }}>
                                <b>View All</b>
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            ...
                            <li>
                              <Link href="/mattressess/orthopedicmattressess">Orthopedic Mattresses</Link>
                            </li>
                            <li>
                              <Link href="/mattressess/pocketmattressess">Pocket Mattresses</Link>
                            </li>
                            <li>
                    ...
                    <li className="dropdown position-static">
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            <li className="title">
                              <Link href="/sofa/chairbed" style={{ color: "#262884" }}>
                                <b>Fabric Sofa</b>
                              </Link>
                            </li>
                            <li>
                              <Link href="/sofa/chairbed">Champion Sofa</Link>
                            </li>
                            <li>
                              <Link href="/sofa/chairbed">
                                Chicago Sofa
                              </Link>
                            </li>
                          </ul>
                    ...
                    <li className="dropdown position-static">
                      <Link href="/product/livingroom"> Living Room Furniture </Link>
                      {/* <i
                                            className="ion-ios-arrow-down"></i> */}
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            <li className="title1">
                              <Link href="/livingroom/chestdrawers" style={{ color: "#262884" }}>
                                <b>Chest Drawers</b>
                              </Link>
                            </li>
                            <li className="title1">
                              <Link href="/livingroom/shelf" style={{ color: "#262884" }}>
                                <b>Shelf</b>
                              </Link>
                            </li>
                            <li className="title1">
                              <Link href="/livingroom/wardrobes" style={{ color: "#262884" }}>
                                <b>Wardrobes</b>
                              </Link>
                            </li>
                            <li className="title1">
                          ...
                          <ul className="d-block">
                            ...
                            <li>
                              <Link href="/livingroom/armchair">Arm Chairs</Link>
                            </li>
                            <li>
                    ...
                    <li className="dropdown position-static">
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            <li className="title1">
                              <Link href="/diningset/diningchairs" style={{ color: "#262884" }}>
                                <b>Dining Chairs</b>
                              </Link>
                            </li>
                            <li className="title1">
                              <Link href="/diningset/diningtables" style={{ color: "#262884" }}>
                                <b>Dining Tables</b>
                              </Link>
                            </li>
                            <li className="title1">
                              <Link href="/diningset/sideboards" style={{ color: "#262884" }}>
                                <b>Sideboards</b>
                              </Link>
                            </li>
                          </ul>
